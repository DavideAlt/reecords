...
@Component({
  selector: 'ree-article',
  templateUrl: './ree-article.component.html',
  styleUrl: './ree-article.component.scss'
})
export class ReeArticleComponent implements OnInit{
  ...
  fetchArticleById(articleId: string) {
    this.article = new Article(articleId, 'Article Title', 'Davide Carità', 'May 29, 2024', this.lorem);
  }
